...
with tab1:
    ...
    if available_files:
        ...
        # Diccionario para nuevas descripciones
        new_descriptions = {}
        
        if selected_files:
            # Crear pestañas para cada archivo seleccionado
            file_tabs = st.tabs(selected_files)
            
            # Mostrar previews y data dictionary
            for tab, filename in zip(file_tabs, selected_files):
                with tab:
                    try:
                        ...
                        # Mostrar/editar información del diccionario de datos
